...
type PetRepository interface {
	...
	PutReadyForAdoptStatus(ctx context.Context, req *Pet.UpdateReadyForAdoptPayload) (res *Pet.Pet, err error)
...
type PetUseCase interface {
	...
	UpdateReadyForAdoptStatus(ctx context.Context, req *Pet.UpdateReadyForAdoptPayload) (res *Pet.Pet, err error)
