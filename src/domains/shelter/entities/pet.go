...
type Pet struct {
	...
	IsAdopted      *bool               `json:"IsAdopted" bson:"is_adopted,omitempty" validate:"omitempty" default:"false"`
	ReadyToAdopt   *bool               `json:"ReadyToAdopt" bson:"ready_to_adopt,omitempty" validate:"omitempty" default:"false"`
